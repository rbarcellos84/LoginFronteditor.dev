...
Este é um projeto estático de página única. Você pode executá-lo de forma extremamente simples:
...
Abra o Arquivo: Simplesmente abra o arquivo login.html em qualquer navegador web moderno.



Não é necessário servidor web local, dependências de pacotes (npm/yarn) ou configurações adicionais.
